...
type ApproverOption struct {
	...
	ForbidModifySealInfos *bool `json:"ForbidModifySealInfos,omitnil,omitempty" name:"ForbidModifySealInfos"`
...
type CreateContractComparisonTaskRequestParams struct {
	...
	RevisionOperation *int64 `json:"RevisionOperation,omitnil,omitempty" name:"RevisionOperation"`
}
...
// Predefined struct for user
type CreateFileConvertTaskRequestParams struct {
...
type CreateFileConvertTaskRequest struct {
	*tchttp.BaseRequest
...
func (r *CreateFileConvertTaskRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateFileConvertTaskRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Agent")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "CreateFileConvertTaskRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CreateFileConvertTaskResponseParams struct {
...
type CreateFileConvertTaskResponse struct {
	*tchttp.BaseResponse
	Response *CreateFileConvertTaskResponseParams `json:"Response"`
}

func (r *CreateFileConvertTaskResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateFileConvertTaskResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type CreateFlowRemindsRequestParams struct {
	...
	RemindTypes []*string `json:"RemindTypes,omitnil,omitempty" name:"RemindTypes"`

	// <p>邮箱覆盖列表，为指定签署人使用特定邮箱发送邮件催办</p>
	RemindEmailInfos []*RemindEmailInfo `json:"RemindEmailInfos,omitnil,omitempty" name:"RemindEmailInfos"`
}
...
func (r *CreateFlowRemindsRequest) FromJsonString(s string) error {
	...
	delete(f, "FlowIds")
	delete(f, "Agent")
	delete(f, "RemindTypes")
	delete(f, "RemindEmailInfos")
	if len(f) > 0 {
...
func (r *CreateOrganizationAuthUrlRequest) FromJsonString(s string) error {
	...
	delete(f, "AddressSame")
	delete(f, "BizLicenseSame")
	if len(f) > 0 {
...
func (r *CreateOrganizationInfoChangeUrlRequest) FromJsonString(s string) error {
	...
	delete(f, "ChangeType")
	delete(f, "Agent")
	delete(f, "UnifiedSocialCreditCode")
	if len(f) > 0 {
...
// Predefined struct for user
type CreatePartnerAuthorizationLinkRequestParams struct {
	// 执行本接口操作的员工信息。<br/>注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
	Operator *UserInfo `json:"Operator,omitnil,omitempty" name:"Operator"`
	...
	PartnerOrganizationId *string `json:"PartnerOrganizationId,omitnil,omitempty" name:"PartnerOrganizationId"`

	// 第三方应用的配置信息。
	// 其中包括 回调地址，加密KEY等信息。
	ApplicationInfo *CallbackInfo `json:"ApplicationInfo,omitnil,omitempty" name:"ApplicationInfo"`

	// 第三方应用下企业用户信息。
	// 其中包括企业的OrganizationOpenId和超管的UserOpenId。
	// 具体含义请参考结构体解释
	ProxyOrganizationInfo *ProxyOrganizationInfo `json:"ProxyOrganizationInfo,omitnil,omitempty" name:"ProxyOrganizationInfo"`
	...
	PartnerApplicationId *string `json:"PartnerApplicationId,omitnil,omitempty" name:"PartnerApplicationId"`
}

type CreatePartnerAuthorizationLinkRequest struct {
	*tchttp.BaseRequest
...
func (r *CreatePartnerAuthorizationLinkRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreatePartnerAuthorizationLinkRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "Operator")
	delete(f, "BusinessId")
	delete(f, "PartnerOrganizationId")
	delete(f, "ApplicationInfo")
	delete(f, "ProxyOrganizationInfo")
	delete(f, "PartnerApplicationId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "CreatePartnerAuthorizationLinkRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CreatePartnerAuthorizationLinkResponseParams struct {
...
type CreatePartnerAuthorizationLinkResponse struct {
	*tchttp.BaseResponse
	Response *CreatePartnerAuthorizationLinkResponseParams `json:"Response"`
}

func (r *CreatePartnerAuthorizationLinkResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreatePartnerAuthorizationLinkResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type CreatePreparedPersonalEsignRequestParams struct {
	...
	// <p>该字段已不再使用</p>
	//
	// Deprecated: EnableAutoSign is deprecated.
...
type CreateSealPolicyRequestParams struct {
	...
	AuthorizationFlows *SealPolicyAuthorizationFlows `json:"AuthorizationFlows,omitnil,omitempty" name:"AuthorizationFlows"`
}
...
type DescribeCancelFlowsTaskRequestParams struct {
	...
	CancelType *uint64 `json:"CancelType,omitnil,omitempty" name:"CancelType"`
}
...
// Predefined struct for user
type DescribeContractReviewMarkedRiskExportTaskRequestParams struct {
	// 执行本接口操作的员工信息。
	// 注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
	Operator *UserInfo `json:"Operator,omitnil,omitempty" name:"Operator"`
...
type DescribeContractReviewMarkedRiskExportTaskRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeContractReviewMarkedRiskExportTaskRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeContractReviewMarkedRiskExportTaskRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Agent")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeContractReviewMarkedRiskExportTaskRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeContractReviewMarkedRiskExportTaskResponseParams struct {
	// 导出文件 url。
	Url *string `json:"Url,omitnil,omitempty" name:"Url"`
...
type DescribeContractReviewMarkedRiskExportTaskResponse struct {
	*tchttp.BaseResponse
	Response *DescribeContractReviewMarkedRiskExportTaskResponseParams `json:"Response"`
}

func (r *DescribeContractReviewMarkedRiskExportTaskResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeContractReviewMarkedRiskExportTaskResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DescribeFileConvertTaskRequestParams struct {
...
type DescribeFileConvertTaskRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeFileConvertTaskRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeFileConvertTaskRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Agent")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeFileConvertTaskRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeFileConvertTaskResponseParams struct {
	// <p>任务Id</p>
	TaskId *string `json:"TaskId,omitnil,omitempty" name:"TaskId"`
...
type DescribeFileConvertTaskResponse struct {
	*tchttp.BaseResponse
	Response *DescribeFileConvertTaskResponseParams `json:"Response"`
}

func (r *DescribeFileConvertTaskResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeFileConvertTaskResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type ExportContractReviewMarkedRiskRequestParams struct {
	// 执行本接口操作的员工信息。
	// 注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
	Operator *UserInfo `json:"Operator,omitnil,omitempty" name:"Operator"`

	// 开始日期。eg， "2006-01-02"
	FromDate *string `json:"FromDate,omitnil,omitempty" name:"FromDate"`

	// 结束日期。eg，"2006-02-01"
	ToDate *string `json:"ToDate,omitnil,omitempty" name:"ToDate"`
...
type ExportContractReviewMarkedRiskRequest struct {
	*tchttp.BaseRequest
...
func (r *ExportContractReviewMarkedRiskRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ExportContractReviewMarkedRiskRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Agent")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ExportContractReviewMarkedRiskRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ExportContractReviewMarkedRiskResponseParams struct {
	// 导出任务 id。
	TaskId *string `json:"TaskId,omitnil,omitempty" name:"TaskId"`
...
type ExportContractReviewMarkedRiskResponse struct {
	*tchttp.BaseResponse
	Response *ExportContractReviewMarkedRiskResponseParams `json:"Response"`
}

func (r *ExportContractReviewMarkedRiskResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ExportContractReviewMarkedRiskResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type ModifyPartnerAuthorizationRequestParams struct {
	// 执行本接口操作的员工信息。<br/>注: `在调用此接口时，请确保指定的员工已获得所需的接口调用权限，并具备接口传入的相应资源的数据权限。`
	Operator *UserInfo `json:"Operator,omitnil,omitempty" name:"Operator"`
...
type ModifyPartnerAuthorizationRequest struct {
	*tchttp.BaseRequest
...
func (r *ModifyPartnerAuthorizationRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyPartnerAuthorizationRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "ApplicationInfo")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ModifyPartnerAuthorizationRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ModifyPartnerAuthorizationResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ModifyPartnerAuthorizationResponse struct {
	*tchttp.BaseResponse
	Response *ModifyPartnerAuthorizationResponseParams `json:"Response"`
}

func (r *ModifyPartnerAuthorizationResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyPartnerAuthorizationResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type RecipientComponentInfo struct {
	...
	// <p>该参与方签批控件信息</p>
	SignComponents []*FilledComponent `json:"SignComponents,omitnil,omitempty" name:"SignComponents"`
}
...
type SealPolicyAuthorizationFlows struct {
	// <p>合同id列表，最大支持50个</p>
	FlowIds []*string `json:"FlowIds,omitnil,omitempty" name:"FlowIds"`

	// <p>合同组id列表， 最大支持10个<br>FlowGroupIds(合同组)与FlowIds(合同列表) 两个参数只能选择其中一个，两者同时传会提示参数错误。</p>
	FlowGroupIds []*string `json:"FlowGroupIds,omitnil,omitempty" name:"FlowGroupIds"`
}
